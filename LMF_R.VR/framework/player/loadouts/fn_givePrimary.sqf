...
switch (_weapon) do {
	case 1: {
		...
		[_unit, selectRandom _SMG, _SMG_Ammo_Amount, _SMG_Ammo] call BIS_fnc_addWeapon;
	...
	case 2: {
		...
		[_unit, selectRandom _Carbine, _Carbine_Ammo_Amount, _Carbine_Ammo] call BIS_fnc_addWeapon;
	...
	case 3: {
		...
		[_unit, selectRandom _Rifle, _Rifle_Ammo_Amount, _Rifle_Ammo] call BIS_fnc_addWeapon;
	...
	case 4: {
		...
		[_unit, selectRandom _Rifle_GL, _Rifle_GL_Ammo_Amount, _Rifle_GL_Ammo] call BIS_fnc_addWeapon;
	...
	case 5: {
		...
		[_unit, selectRandom _DMR, _DMR_Ammo_Amount, _DMR_Ammo] call BIS_fnc_addWeapon;
	...
	case 6: {
		...
		[_unit, selectRandom _LMG, _LMG_Ammo_Amount, _LMG_Ammo] call BIS_fnc_addWeapon;
	...
	case 7: {
		...
		[_unit, selectRandom _MMG, _MMG_Ammo_Amount, _MMG_Ammo] call BIS_fnc_addWeapon;
